...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Option Pricing", tabName = "optionpricing", icon = icon("line-chart")),
    ...
    tabItems(
      ...
      tabItem(tabName = "forwardpricing",
              ...
              fluidRow(
                ...
                box(
                  title = "Load and save",width = 12, status = "primary", solidHeader = TRUE, collapsible = TRUE,
                  actionButton("loadLoadDB", "Load from database"),
                  actionButton("loadSaveDB", "Save to database"),
