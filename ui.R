    ...
    tabItems(
      tabItem(tabName = "forwardpricing",
              ...
              fluidRow(
                ...
                box(
                  title = "Initial Pricing",width = 12, status = "primary", solidHeader = TRUE, collapsible = TRUE,
      ...
      tabItem(tabName = "tableexplorer",
              ...
              fluidRow(
                box(
                  title = "Database Control",width = 12, status = "primary", solidHeader = TRUE, collapsible = TRUE,
                ...
                box(
                  title = "Table: Interest_Rate", width = 12, align="center", status = "primary", solidHeader = TRUE,
                  collapsible = TRUE,
                ...
                box(
                  title = "Table: Asset", width = 12, align="center", status = "primary", solidHeader = TRUE,
                  collapsible = TRUE,
                ...
                box(
                  title = "Table: Liability", width = 12, align="center", status = "primary", solidHeader = TRUE,
                  collapsible = TRUE,
                ...
                box(
                  title = "Table: Off_Balance", width = 12, align="center", status = "primary", solidHeader = TRUE,
                  collapsible = TRUE,
